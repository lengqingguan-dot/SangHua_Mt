...
Object.assign(ITEM_TEMPLATES, {
    ...
    cecilia_leg: { id: "cecilia_leg", name: "塞西莉亚的腿", type: "limb", cookable: true, ingredientType: "leg", resultDish: "cecilia_leg_steak", desc: "一条娇小纤细的腿，属于男爵女儿塞西莉亚·冯·兰德尔。长度适中却非常瘦弱，大腿圆润柔软，小腿细直。皮肤白皙细嫩，覆盖着几乎看不见的细软绒毛。大腿根部干净白嫩，断面露出细小的腿骨与柔软的粉红肌肉，鲜血顺着大腿根部缓缓流下，显得脆弱而诱人。" },
    cecilia_foot: {
    ...
    cecilia_arm: { id: "cecilia_arm", name: "塞西莉亚的手臂", type: "limb", cookable: true, ingredientType: "arm", resultDish: "cecilia_arm_dish", desc: "一条纤细柔弱的手臂，属于男爵女儿塞西莉亚·冯·兰德尔。皮肤白嫩如瓷，几乎没有一丝肌肉线条。手臂内侧特别细腻，能看到淡淡的蓝色血管。断面露出细小的臂骨与薄薄的粉色肌肉层，鲜血从切口轻轻流下，染红了原本洁白的皮肤。" },
    cecilia_hand: {
