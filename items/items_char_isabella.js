...
Object.assign(ITEM_TEMPLATES, {
    ...
    isabella_leg: { id: "isabella_leg", name: "伊莎贝拉的腿", type: "limb", cookable: true, ingredientType: "leg", resultDish: "isabella_leg_steak", desc: "一条修长丰满的腿，属于男爵夫人伊莎贝拉·冯·兰德尔。被黑色丝袜紧紧包裹，大腿饱满圆润，小腿线条流畅，充满弹性。丝袜被鲜血浸透后贴在皮肤上，勾勒出诱人的曲线。断面露出粗壮的腿骨与丰厚的粉红肌肉，鲜血顺着大腿根部缓缓流下，把黑色丝袜染成妖艳的红黑。" },
    isabella_foot: {
    ...
    isabella_arm: { id: "isabella_arm", name: "伊莎贝拉的手臂", type: "limb", cookable: true, ingredientType: "arm", resultDish: "isabella_arm_dish", desc: "一条圆润丰满的手臂，属于男爵夫人伊莎贝拉·冯·兰德尔。皮肤白皙紧致，线条柔美却带着成熟女性的肉感。手臂内侧特别细嫩。由于长期被紧身衣物包裹，这条手臂保留着一种被精心养护的奢靡质感，摸上去软弹而温暖，仿佛随时能溢出成熟女性的甜腻。断面露出粉红的肌肉层与白色臂骨，这条曾经只用来拥抱男爵或在丝绸床单上自慰的手臂，现在只是一个淫靡的残肢。" },
    isabella_hand: {
