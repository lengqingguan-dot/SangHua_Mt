...
const WORLD_TEMPLATE_1 = {
    ...
    residence_w1: {
        ...
        exits: { south: "town_road_w1", north: "slum_west_n1", east: "bakery" },
        items: [],
        npcs: []
    },
    bakery: {
        name: "贫民窟西",
        desc: "一片破败的棚屋区，低矮的木棚和石砌小屋杂乱地挤在一起。\n墙壁歪斜，屋顶的茅草和铁皮在风中吱呀作响。\n地面上满是泥泞和碎石，角落里堆着发霉的干草和破烂的麻布。\n空气中弥漫着潮湿、霉烂和贫穷的气息。",
        exits: { south: "town_road_w2", north: "slum_west_n2", west: "residence_w1", east: "residence_w3" },
        items: [],
        npcs: []
    },
    residence_w3: {
        name: "贫民窟西",
        desc: "一片破败的棚屋区，低矮的木棚和石砌小屋杂乱地挤在一起。\n墙壁歪斜，屋顶的茅草和铁皮在风中吱呀作响。\n地面上满是泥泞和碎石，角落里堆着发霉的干草和破烂的麻布。\n空气中弥漫着潮湿、霉烂和贫穷的气息。",
        exits: { south: "town_road_w3", north: "slum_west_n3", west: "bakery" },
        items: [],
        npcs: []
    },
    ...
    slum_east_1: {
        name: "贫民窟东",
        desc: "一片破败的棚屋区，低矮的木棚和石砌小屋杂乱地挤在一起。\n墙壁歪斜，屋顶的茅草和铁皮在风中吱呀作响。\n地面上满是泥泞和碎石，角落里堆着发霉的干草和破烂的麻布。\n空气中弥漫着潮湿、霉烂和贫穷的气息。",
        exits: { south: "town_road_e1", north: "slum_east_n1", east: "slum_east_2" },
        items: [],
        npcs: []
    },
    slum_east_2: {
        name: "贫民窟东",
        desc: "一片破败的棚屋区，低矮的木棚和石砌小屋杂乱地挤在一起。\n墙壁歪斜，屋顶的茅草和铁皮在风中吱呀作响。\n地面上满是泥泞和碎石，角落里堆着发霉的干草和破烂的麻布。\n空气中弥漫着潮湿、霉烂和贫穷的气息。",
        exits: { south: "town_road_e2", north: "slum_east_n2", west: "slum_east_1" },
        items: [],
        npcs: []
    },
